...
function MoviePage() {
  ...
  async function fetchMovies() {
    try {
      let response = await axios.get(`${BASE_URL}?apikey=${API_KEY}&s=movie`);
        ...
        <Container> 
          <Modal show={showModal} onHide={handleCloseModal}>
            ...
            <Modal.Body>
              ...
              <p><strong>Description:</strong> {selectedMovie.Plot}</p> {/* Updated to use Plot */}
            </Modal.Body>
            <Modal.Footer>
