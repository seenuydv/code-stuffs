...
//     } else {
//       // Add new product to local storage if it doesn't exist
...
//     localStorage.setItem(product.name, JSON.stringify(storedItems));
//   };
...
//       if (newCount === 0) {
//         // Remove the product from local storage if count is 0
//         removeProductFromLocalStorage();
//       } else {
//         // Update the product count in local storage
//         storeProductInLocalStorage(newCount);
//       }
//     }
//   };

//   // Function to handle initial "Add" button click
//   const handleAdd = () => {
...
//                 </Button>
//               ) : (
//                 // Show increment and decrement buttons with count when the product is added
